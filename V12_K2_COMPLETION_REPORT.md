...
11. Repaired Vue header safe-area and variant geometry for home/subpage contracts.
12. Repaired Vue bottom bar active state, CTA badge and item alignment enough for most route surfaces to pass strict visual regression.
13. Added stable subtitle parity data for core migrated routes.

## Not Completed

- Special route header strict visual parity remains above `0.015`.
- Subscription bottom bar strict visual parity remains above `0.015`.
