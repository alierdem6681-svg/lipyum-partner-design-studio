...
V11 ile kalite otomasyonu geni�letildi:

- CTA sis efektinin gecikmeli/reduced-motion davran���.
- Bildirimler header ayar aksiyonu.
- Profil 4x2 grid geometri testi.
- Route metadata ve legacy migration audit.

Bu kontroller `npm run test:quality-gate` ve `npm run test:quality-gate:v11` i�ine dahil edildi.
