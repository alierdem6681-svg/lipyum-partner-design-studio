...
test("V12-F keeps Vue cutover gated until final approval", () => {
  ...
  assert.match(appJs, /else\s*\{\s*import\(["']\.\/legacyApp\.js["']\)/s, "legacy Golden runtime must remain the default boot");
