...
const titleOverrides = {
  ...
  "/performance-score": {
    title: "Daha Fazla ?? Al",
    subtitle: "Puan?n? y?kselt, daha fazla i? f?rsat? g?r.",
    trailingActions: [],
  },
  "/performance-score/task/job-result": {
    title: "?? Bilgilerini Gir",
    subtitle: "Tamamlay?nca puan?n hemen g?ncellenir.",
    parentRoute: "/performance-score",
    trailingActions: [],
  },
  "/performance-score/tasks": {
    title: "T?m G?revler",
    subtitle: "En kolay ve y?ksek puanl? i?ler ?stte.",
    parentRoute: "/performance-score",
    trailingActions: [],
  },
  "/performance-score/details": {
    title: "Puan?n Nas?l Hesaplan?r?",
    subtitle: "Toplam 100 puan ?zerinden hesaplan?r.",
    parentRoute: "/performance-score",
    trailingActions: [],
  },
  "/performance-score/success": {
    title: "G?rev Tamamland?",
    subtitle: "Yapt???n i?lem puan?na eklendi.",
    parentRoute: "/performance-score",
    trailingActions: [],
  },
  "/performance-improve": {
  ...
  "/customer-management": { title: "M??teri Y?netimi", subtitle: "", trailingActions: [] },
  ...
  "/create-offer": { title: "Teklif Olu?tur", subtitle: "", trailingActions: [] },
