export function mountAppShell(root = document.getElementById("app")) {
  ...
  root.innerHTML = `
    <svg class="svg-sprite" aria-hidden="true">
      ...
      <symbol id="i-coin" viewBox="0 0 24 24"><circle cx="12" cy="12" r="9"/><path d="M8 12h8"/><path d="M12 8v8"/><path d="M7.8 7.8c2.6 1.4 5.8 1.4 8.4 0"/><path d="M7.8 16.2c2.6-1.4 5.8-1.4 8.4 0"/></symbol>
      <symbol id="i-bell" viewBox="0 0 24 24"><path d="M18 8a6 6 0 0 0-12 0c0 7-3 7-3 9h18c0-2-3-2-3-9"/><path d="M10 21h4"/></symbol>
      <symbol id="i-gift" viewBox="0 0 24 24"><rect x="3" y="8" width="18" height="13" rx="2"/><path d="M12 8v13"/><path d="M3 12h18"/><path d="M7.5 8a2.5 2.5 0 1 1 4.5-1.5V8"/><path d="M16.5 8A2.5 2.5 0 1 0 12 6.5V8"/></symbol>
      ...
      <symbol id="i-package" viewBox="0 0 24 24"><path d="m21 8-9-5-9 5 9 5 9-5z"/><path d="M3 8v8l9 5 9-5V8"/><path d="M12 13v8"/></symbol>
      ...
      <main class="phone-stage" aria-label="Mobil uygulama prototipi">
        <div class="phone">
          <div class="phone-screen">
            ...
            <div class="app">
              <div class="pull-refresh" id="pullRefresh" aria-live="polite">
                <span class="pull-spinner"><svg class="icon"><use href="#i-refresh"></use></svg></span>
