    ...
    <div v-if="open" class="fixed inset-0 z-50 flex items-center justify-center bg-slate-950/35 px-4" role="presentation">
      ...
      >
        <div class="flex items-start justify-between gap-3">
          ...
          <button class="grid h-11 w-11 place-items-center rounded-xl border border-slate-200" type="button" data-testid="modal-close-button" :aria-label="closeLabel" @click="emit('close')">
